...
export default function About() {
  return (
    <main className="relative pt-[110px]">
        ...
        {/* Hero Section */}
        <section className="min-h-[70vh] pt-40 px-margin-desktop md:px-margin-desktop flex flex-col justify-end pb-20 relative">
        ...
        {/* Struktur Organisasi */}
        <section className="py-[120px] px-margin-desktop bg-surface-container-highest/30">
        ...
        {/* CTA Section */}
        <section className="py-[120px] px-margin-desktop text-center overflow-hidden relative">
